  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <motion.div
        ...
        className="absolute top-0 left-1/2 transform -translate-x-1/2 w-full max-w-5xl px-8 md:px-16 pt-10 pb-6 bg-white/10 backdrop-blur-sm text-white shadow-lg rounded-b-lg"
      >
