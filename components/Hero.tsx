      ...
      <section className="bg-white text-black px-6 py-20">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg leading-relaxed">
            This rare parcel offers up to 15 buildable lots on 1.6 continuous acres near the heart of Chattanooga. Zoned for residential development with utilities nearby and easy access to key locations.
          </p>
        </div>
      </section>
    </>
